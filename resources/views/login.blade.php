...
<html lang="en">
  ...
  <div class="continer bg-success bg-opacity-10">
      <div class="row">
          <div class="col-sm-4">
            <main class="form-signin text-center px-4 mt-5">
              <form action = "/login" method ="post">
                @csrf
                <img class="mb-2" src="/img/kua.png" alt="bumk" width="110" height="100">
                ...
                <div class="container-btn-login">
                  <input class="btn btn-success px-5 mb-3" type="submit" value="Login">
                </div>
              </form>
