...
<div class="container">
    <div class="mt-4 row">
        <div class="mb-4 bg-opacity-50 bg-success bg-pf">
            <h6 class="py-2 text-center fs-3 ">Calon Pengantin Pria</h6>
        </div>
        <div class="col-md-7">

            <form action="/calon-pengantin/pria/{{ $akad_id->id_akad }}" method ="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row">
                    <label for="nama" id ="nama"class="col-sm-3 col-form-label fs-6 fw-bolder ">Nama Calon Pengatin Pria</label>
                ...
                <div class="mb-3 row">
                    <label for="nik" id="nik" class="col-sm-3 col-form-label fs-6 fw-bolder ">NIK Calon Pengatin Pria </label>
                    <div class="mt-3 col-sm-8">
